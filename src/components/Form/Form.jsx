  ...
  return (
    <form className='mb-4 font-primary w-full'>
      <input
        ...
        placeholder='Que tarea tenes? ' onChange={(evt) => setValue(evt.target.value)}
      />
      <button className="bg-gray-700 border-none p-2 text-white cursor-pointer rounded ml-2"> Agregar Tarea</button>
    </form>
  );
};
